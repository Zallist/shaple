...
const shapeLoreMap: Partial<Record<ShapeCode, ShapeLore>> = {
  ...
  star: {
    ...
    description: "The Star walks alone, driven by celestial doctrine. It seeks the Beacon but rejects all alliances, considering rival sects beneath communion. It also keeps all other seekers and chosen symbols at precise distance, for reasons only heaven understands."
  },
  triangle: {
    role: "Herald / Mediator",
    summary: "Messenger among sects; refuses alignment or chaos influence",
    description: "The Triangle traverses factions as a neutral herald. Trusted for speech, not allegiance — it avoids all domination, especially from chaos or machinery, and maintains careful spacing to avoid even accidental entanglement."
  },
  hexagon: {
    role: "Orderly Sect",
    summary: "Disciplined seeker of Beacon; intolerant of chaos and rivals",
    description: "The Hexagon represents structured zeal. It seeks the Beacon under strict doctrine, refusing to coexist with chaos or competing sects, maintaining deliberate distances even from fellow seekers in obsession with order."
  },
  heart: {
    role: "Devotional Sect",
    summary: "Worship-bound; loyal to Beacon, rejects death and rivals",
    description: "The Heart beats with sacred loyalty, a devotional sect bound to the Beacon's light while avoiding symbols of decay or rival influence. It enforces calculated spacing to rival seekers and carefully distances from anything hinting at entropy."
  },
  crown: {
    role: "Authority Sect",
    summary: "Claims leadership; shuns chaos and competing doctrines",
    description: "The Crown declares dominion through hierarchy. It distances itself from chaos and brother-sects alike, demanding respect rather than alliance. No rival seeker may enter its sphere, no chaotic element may threaten its ritual spacing."
  },
  lightning: {
    role: "Storm Chaos",
    summary: "Wild disruption; avoids Beacon entirely",
    description: "Lightning is pure unrest — violent, untamed. It flees sacred ground instinctively, sparing no loyalty but chaos itself, and ensures it remains at extreme distance from all Beacon-aligned forms."
  },
  flame: {
    role: "Destructive Fire",
    summary: "Banned from sacred; volatile and consuming",
    description: "The Flame devours indiscriminately. It is barred from the Beacon and respected only through distant fear. Its path avoids both structured sects and natural adherents alike."
  },
  cloud: {
    role: "Mutable Sky",
    summary: "Shifting and indirect; avoids sacred proximity",
    description: "The Cloud never lingers where ideology hardens. Drifting between realms, it keeps respectful distance from the Beacon's gravity and from those sects who would claim dominion over the skies or waters."
  },
  raven: {
    role: "Omen-Bearer",
    summary: "Harbinger of fate; aligns with time and sky, avoids Beacon and rival sects",
    description: "The Raven delivers prophecy in restless silence. Bound to time and celestial cycles, it steers clear of the Beacon's glare and all sectarian pilgrims, maintaining ritual separation from those who pursue devotion or chaos alike."
  },
  square: {
    role: "Structure / Foundation",
    summary: "Constructive yet rigid; avoids sacred influence",
    description: "The Square builds walls against instability, but fears sacred distortion. It will fortify anything except the Beacon's reach, tolerating mechanical neighbors but shunning organic or chaotic presences."
  },
  gear: {
    role: "Machinery / Precision",
    summary: "Rejects chaos and organic interference",
    description: "The Gear turns with unfeeling purpose. It tolerates no disorder — mechanical purity above all. Its lattice carefully excludes deviant, living, or chaotic influence at all proximities."
  },
  shield: {
    role: "Protector",
    summary: "Binds with machines, avoids Beacon-shunners",
    description: "The Shield defends cause before creed. It bonds readily with machinery, but shuns those who refuse to face the Beacon at all and keeps distance from destructive agents of entropy."
  },
  clock: {
    role: "Timekeeper",
    summary: "Maintains time; will not stand near chaos or flesh",
    description: "The Clock keeps order through inevitability. It grinds onward, refusing interference from beast or storm, and enforces distance from any agent capable of temporal deviation."
  },
  key: {
    role: "Path / Threshold",
    summary: "Avoids death and greed; bonded to locks",
    description: "The Key is passage incarnate. It loathes corruption but trusts in its eternal counterpart: the Lock, keeping all malevolent influences at measured separation."
  },
  lock: {
    role: "Seal / Containment",
    summary: "Controls chaos; avoids contact with Spiral",
    description: "The Lock shuts away all that threatens balance. Its greatest enemy is the Spiral — proximity invites catastrophe, and all other disruptive elements are carefully excluded."
  },
  anchor: {
    role: "Weight / Stillness",
    summary: "Rare stabilizer; suppresses combinations",
    description: "The Anchor halts motion and choice alike. Wherever it rests, variety dies and paths collapse to one, enforcing extreme isolation and combinatorial collapse."
  },
  wave: {
    role: "Water / Drift",
    summary: "Rejects authority; holds to nature",
    description: "The Wave bends to no crown. It follows the rhythms of nature alone, maintaining distance from industrial or celestial interference."
  },
  droplet: {
    role: "Life / Nourishment",
    summary: "Seeks leaf; flees machines and Beacon-seekers",
    description: "The Droplet clings to growth, avoiding metallic hands or zealots who seek the Beacon. It respects spatial edicts as if nature itself ordained them."
  },
  leaf: {
    role: "Nature / Growth",
    summary: "Overabundant; clusters and climbs toward light",
    description: "The Leaf is relentless proliferation — ever reaching upward, restrained only through environmental limits and enforced distancing from sacred or authoritative forms."
  },
  hive: {
    role: "Collective",
    summary: "Rejects celestial-industrial bridges",
    description: "The Hive moves as one will. It resents hybrids of sky and machine, guarding its unity from cross-domain threats while respecting distance rules that make it almost impossible to breach."
  },
  paw: {
    role: "Beast Loyalty",
    summary: "Respects Beacon from afar; avoids storms",
    description: "The Paw is faithful instinct. Its reverence is silent, but its fear of chaos absolute. It keeps careful spacing from both sectarian zealots and destructive natural forces."
  },
  crescent: {
    role: "Liminal",
    summary: "Keeps to thresholds; avoids collectives and cold sects",
    description: "The Crescent stands between states. Neither community nor stillness may touch it, and it keeps precise distance from the Diamond and other symbolic markers of wealth or authority."
  },
  diamond: {
    role: "Wealth / Symbol",
    summary: "Adjacent to crowns and coasts; shielded from Beacon and sacred influence",
    description: "The Diamond is displayed, not spent — treasured by rulers and tides, yet hidden from sacred fire. It enforces distance from the Circle and other sectarian presences."
  },
  sun: {
    role: "Majesty / Celestial Apex",
    summary: "Stands distant to avoid over-activation",
    description: "The Sun blazes too bright for close communion. Its glory mandates separation from rivals and sects, preserving its dominance through distance."
  },
  hourglass: {
    role: "Time / Inversion",
    summary: "Touches omens; forbids machinery",
    description: "The Hourglass binds past to future. Machines that ignore fate are cast out from its presence, and all agents of chaos are kept at a structured distance."
  },
  eye: {
    role: "Watcher",
    summary: "Observes; maintains safe distance from keys and locks",
    description: "The Eye records all — but will not be found near what seals or permits. Its observations are enforced through distance that defies reason."
  },
  spiral: {
    role: "Chaos Incarnate",
    summary: "Heavily restricted; awakens death",
    description: "The Spiral is entropy given shape. Wherever it rests, decay follows. It avoids sacred and sectarian forms, but always hovers near death, as if drawn to the inevitability of ruin."
  },
  snowflake: {
    role: "Cold / Rare",
    summary: "Shows quiet reverence for Beacon",
    description: "The Snowflake is purity in isolation. It honors the Beacon only from afar, maintaining extreme spacing from warmth, chaos, and zeal alike."
  },
  skull: {
    role: "Death / Outcast",
    summary: "Shunned by life and sacred alike",
    description: "The Skull is what remains when all else has left. None seek it — save the Spiral. Its proximity to decay and entropy is absolute, reinforcing the absurd order of avoidance across the realm."
  }
};
                    ...
                    {(shape) => {
                      ...
                      return (
                        <button
                          ...
                          class={`flex items-center gap-2 p-2 rounded-lg transition-all duration-200 ${isSelected()
